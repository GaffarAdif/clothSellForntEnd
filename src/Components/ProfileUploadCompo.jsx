...
export const ProfileUploadCompo = ({ changeUpload, porfileState }) => {
  ...
  const HandleProfilePic = (e) => {
    ...
    axios
      .post("http://localhost:3000/profileUpdate", formData, {
        headers: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="h-[100px]  w-[100px] bg-blue-300 rounded-full flex justify-center items-center ">
