    ...
    <div>
      <div className="w-full h-10  flex lg:h-[50px] z-50">
        ...
        <div className="w-[70%]  h-10 lg:h-[50px]  flex gap-1 lg:lg:w-[50%]">
          <input
            className="w-[80%] h-8 mt-1 rounded-sm px-1 lg:h-10 lg:rounded-md bg-transparent border border-black"
            type="text"
            name=""
            id=""
            placeholder="Search.."
          />
          <button className="w-[20%] h-8 mt-1 flex justify-center items-center">
            {" "}
        ...
        <div
          className={` ${
            window.innerWidth < 1024 ? "HeaderFixedPosition" : null
          } lg:w-[55%] lg:h-[50px] lg:flex lg:justify-center lg:items-center lg:gap-8`}
        >
          <NavLink
            to="/"
            className={({ isActive }) =>
              isActive
                ? `flex flex-col items-center text-[20px]   `
                : `flex flex-col items-center text-[#718355]`
            }
          >
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? `flex flex-col items-center relative text-[20px]   `
                : `flex flex-col items-center relative   text-[#718355]`
            }
          >
          ...
          >
            ...
            <span className="mt-[-4px] hover:text-[12px] lg:mt-0">
              Acccount
            </span>
          </NavLink>
        </div>
