...
export const Busket = () => {
  ...
  return (
    <div
      className={`mx-5  ${busketData.length == 0 ? "busketFullScreen" : null} `}
    >
      <Header />
      ...
      {busketData.length !== 0 ? (
          ...
          <div className="h-fit w-full">
            ...
            {busketData.map((value, ind) => {
              return (
                <BusketCompo
                  key={ind}
                  quyantity={value.productQuyantity}
            ...
            <div className="w-full h-12 lg:w-[30%] lg:mx-auto  mt-5 flex gap-2">
              <div className="w-[40%] bg-slate-400 rounded-md grid place-content-center">
                <span>
                  Total Price <br /> 500 BDT
                </span>
              </div>
              <button
                onClick={PlaceOrderHandle}
                className="w-[60%] bg-purple-400 rounded-md"
              >
                Place Order
              </button>
            </div>
        ...
        <div className="divHightWithoutHeader w-full  flex justify-center items-center">
          <h3 className="text-center text-[25px]">
            Your Busket Is Emty <br /> Please Add Item{" "}
          </h3>
        </div>
      )}
    </div>
